...
`jmall`项目致力于打造一个完整的电商系统，采用现阶段流行技术实现。
...
`jmall`项目是一套电商系统，包括前台商城系统及后台管理系统，基于SpringBoot+MyBatis实现。
...
[Apache License 2.0](https://github.com/spence9527/jmall/new/master/LICENSE)

Copyright (c) 2018-2019 spence9527
